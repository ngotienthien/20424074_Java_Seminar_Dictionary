 ...
 * @author ngoti
 */
public class JPResetDictionary extends javax.swing.JPanel {
    ...
    public JPResetDictionary(TreeMap _DictionarySlangWord) {
    ...
    private void initComponents() {
        ...
        jLTitle.getAccessibleContext().setAccessibleName("Reset từ điển");
